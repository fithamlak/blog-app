...
describe 'Users index page', type: :system do
  describe 'Integration test to test content of the users#index page' do
    before(:each) do
      @user1 = User.create(name: 'Justice', photo: 'https://robohash.org/idquiet.png', bio: 'software developer')
      @user2 = User.create(name: 'Solomon', photo: 'https://robohash.org/adipiscivoluptatesea.png', bio: 'coder')
